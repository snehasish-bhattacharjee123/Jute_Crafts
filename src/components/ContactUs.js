...
function ContactUs() {
  ...
  return (
    <div className="min-h-screen bg-bgGrey">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  <div>
                    <label className="block text-sm font-medium text-textDark mb-2 font-body">
                      Full Name *
                    </label>
                    <input
                      name="name"
      ...
      {/* Map and other sections (keep yours below) */}
      {/* ... your testimonials and footer sections unchanged ... */}
    </div>
  );
}
