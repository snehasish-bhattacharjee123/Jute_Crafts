    ...
    return (
      <div className="min-h-screen bg-bgLight flex items-center justify-center">
        <div className="text-center max-w-md mx-auto px-4">
          ...
          <a
            href="/contact"
            className="mobile-touch focus-enhanced inline-block px-6 py-3 bg-primary text-white rounded-full font-body hover:bg-primary/90 transition-colors"
          >
            Contact Support
          </a>
        </div>
      ...
      <div className="min-h-screen bg-bgLight pt-8">
        ...
        <section className="py-12 md:py-16 bg-gradient-to-r from-primary/5 to-gold/5">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <h1 className="hero-title text-3xl sm:text-4xl md:text-5xl font-heading font-semibold text-textDark mb-6">
              Complete Rug Care Guide
            </h1>
            <p className="hero-subtitle text-lg text-textDark/80 font-body leading-relaxed max-w-3xl mx-auto">
        ...
        <section className="py-12 bg-gradient-to-r from-primary/5 to-gold/5">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h2 className="section-title text-2xl sm:text-3xl font-heading font-semibold text-textDark mb-4">
              Still Have Questions?
            </h2>
            <p className="section-subtitle text-lg text-textDark/80 font-body mb-6 leading-relaxed">
            ...
            <div className="flex flex-wrap gap-4 justify-center">
              <a
                ...
                className="mobile-touch focus-enhanced inline-flex items-center gap-2 px-6 py-3 bg-primary text-white rounded-full font-body hover:bg-primary/90 transition-colors duration-200"
              >
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="mobile-touch focus-enhanced inline-flex items-center gap-2 px-6 py-3 bg-green-600 text-white rounded-full font-body hover:bg-green-700 transition-colors duration-200"
              >
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a
                href="/contact"
                className="mobile-touch focus-enhanced inline-flex items-center gap-2 px-6 py-3 bg-white text-primary border-2 border-primary rounded-full font-body hover:bg-primary/5 transition-colors duration-200"
              >
                Contact Form
              </a>
            </div>
