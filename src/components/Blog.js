...
export const blogs = [
  {
    ...
    img: "/images/DELHI FAIR WEB Page.png",
    category: "export",
    readTime: "5 min read",
    featured: true,
    metaTitle:
          ...
          {isLoading && (
            <div className="flex justify-center items-center py-12 sm:py-16 md:py-20">
              <div className="flex items-center gap-2 sm:gap-3">
                ...
                <span className="text-sm sm:text-base text-[#4a3a3a] font-medium">
                  Loading articles...
                </span>
              </div>
            </div>
